...
newDataTRAIN = train.drop(['tip_amount', 'tpep_pickup_datetime', 'tpep_dropoff_datetime', 'trip_amount', 'trip_distance', 'minutes'], axis=1)
newDataTEST = test.drop(['tip_amount', 'tpep_pickup_datetime', 'tpep_dropoff_datetime', 'trip_amount', 'trip_distance', 'minutes'], axis=1)
